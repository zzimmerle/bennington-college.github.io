...
export class AppComponent 
{
    ...
    ngAfterViewInit(): void
    {
        ...
        this.myPopover.createWidget(this.popoverSettings);
        this.button.createWidget({ width: 150, height: 35 });
    }
    ...
    generateItems(): void
    {
        ...
        let itemsContainer = <HTMLElement>document.getElementById('movies');
    ...
    popoverSettings: jqwidgets.PopoverOptions =
    {
