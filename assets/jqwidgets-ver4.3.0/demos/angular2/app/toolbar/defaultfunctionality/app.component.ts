...
@Component({
    selector: 'my-app',
    template: `<angularToolbar #toolBarReference></angularToolbar>`,
    styles: [`
        .buttonIcon
        {
            margin: -5px 0 0 -3px;
...
{
    @ViewChild('toolBarReference') toolBar: jqxToolBarComponent;

    ngAfterViewInit(): void 
    {
        this.toolBar.createWidget(this.toolBarSettings);
    }
